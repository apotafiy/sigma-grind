class Eregion {
    constructor(game, x, y) {
        ...
        this.soundEffects.ball_attack = SOUND_MANAGER.getSound(
            'eregion_ball_attack'
        );
        this.soundEffects.up_attack =
            SOUND_MANAGER.getSound('eregion_up_attack');
    }
    ...
    loadAnimations() {
        ...
        this.animations[1] = new Animator( //Left wing
            ASSET_MANAGER.getAsset(
                './sprites/eregion/eregion_wings_118x142.png'
            ),
            0,
            0,
            142,
